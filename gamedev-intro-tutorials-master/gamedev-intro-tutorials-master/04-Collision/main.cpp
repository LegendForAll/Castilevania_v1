...
void LoadResources()
{
	...
	//CBrick *mario = new CBrick();
	//mario->AddAnimation(SM_STAND_STATIC);
	//mario->SetPosition(100.0f, 315);
	...
	mario->SetState(SM_STAND_ATTACK);			//set trang thai simon
	objects.push_back(mario);
...
void Update(DWORD dt)
{
	...
	//SetView port cho mario
	viewPort->SetCameraPosition(posX, SCREEN_HEIGHT - 25);
}
...
void Render()
{
	...
	if (d3ddv->BeginScene())
	{
		...
		//render Background
		//LPDIRECT3DTEXTURE9 texBG = textures->Get(ID_TEX_SIMON);
